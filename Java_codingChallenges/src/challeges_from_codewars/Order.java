...
public class Order {
	...
	/**
	 * This method takes a string, the string using .split(" ") taking every
	 * backspace out the string. Then it is stored in an array called words_arr. if
	 * the string is empty it will going to be an empty space. If the string is not
	 * empty then should go through a nested loop which search for the digit value
	 * and organize the elements on a new array The using the join method to
	 * combined all elements in the array and to concatenate the space bar and then
	 * it is returned.
	 * 
	 * 
	 * @param words
